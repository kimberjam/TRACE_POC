...
def _hero() -> None:
    st.markdown(
        ...
        f'Every U.S. hospital that bills Medicare already submits '
        f'antibiotic-use and antibiotic-resistance data under the 2024 '
        f'CMS NHSN mandate. Today that data is buried in state and federal '
        f'silos and returned to clinicians, if at all, as a blurred annual '
        f'average. TRACE ingests the same data hospitals already have to '
        f'generate, then converts it into continuously updated, '
        f'ZIP-code-level resistance intelligence — delivered as '
        f'role-specific web dashboards and, for EHR-integrated environments, '
        f'CDS Hooks cards at the moment of prescribing.'
        f'</p>'
